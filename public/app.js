...
const highlightEngine = window.HighlightEngine || {
  escapeHTML: (str = "") =>
    str
      .replace(/&/g, "&amp;")
      .replace(/</g, "&lt;")
...
const highlightCode = (value) => highlightEngine.highlightCode(value || "");
const escapeHTML = (value) => highlightEngine.escapeHTML(value || "");
...
function syncHighlight(textarea, highlightEl) {
  ...
  const highlighted = highlightCode(textarea.value || "");
